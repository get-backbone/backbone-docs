...
Backbone operates at the application platform layer, not as a landing zone. See [Platform features — Licence tiers](/docs/features#licence-tiers-and-platform-configuration).
